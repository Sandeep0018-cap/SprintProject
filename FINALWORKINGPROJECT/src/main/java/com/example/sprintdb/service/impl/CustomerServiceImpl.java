...
public class CustomerServiceImpl implements CustomerService {
    ...
    public List<CustomerRowDto> listCustomersWithLastPurchase() {
        ...
        customers.forEach(c ->
            System.out.println("Customer " + c.getCustomer_id() + " city = [" + c.getCity() + "]"));
        ...
        Map<Long, Purchase> lastPurchaseByCustomer = purchases.stream()
                .collect(Collectors.toMap(p -> p.getCustomer().getCustomer_id(),
                        p -> p,
        ...
        return customers.stream().map(c -> {
            ...
            dto.setCustomerId(c.getCustomer_id());
            dto.setName(c.getName());
            dto.setPhone(c.getPhone());
            dto.setCity(c.getCity());

            Purchase last = lastPurchaseByCustomer.get(c.getCustomer_id());
            if (last != null) {
